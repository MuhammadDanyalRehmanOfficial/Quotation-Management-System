...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $mysqli->prepare("INSERT INTO quotations(user_id, customer_id, quote_date, validity_date, note, status) VALUES(?,?,?,?,?,'draft')");
    $stmt->bind_param('issss', $userId, $customer_id, $quote_date, $validity_date, $note);
    $stmt->execute();
    $qid = $stmt->insert_id;
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form method="post" class="row g-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                <input class="form-control" type="datetime-local" id="quote_date" name="quote_date" value="<?= date('Y-m-d\TH:i') ?>">
                        ...
                        <div class="col-md-3">
                            <div class="form-floating">
                                <input class="form-control" type="date" id="validity_date" name="validity_date">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" id="note" name="note" placeholder="Add notes..." style="height: 120px"></textarea>
